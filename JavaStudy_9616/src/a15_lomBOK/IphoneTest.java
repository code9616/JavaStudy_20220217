...
public class IphoneTest {
	...
	public static void main(String[] args) {
		...
		Iphone iphone13Mini = new Iphone(12, "mini", "black", 256, LocalDate.parse("2020-01-01").getYear());
		Iphone iphone12Max = new Iphone(12, "mini", "red", 128, LocalDate.parse("2020-01-01").getYear());
		Iphone iphone13Max = new Iphone(12, "mini", "blue", 512, LocalDate.parse("2020-01-01").getYear());
